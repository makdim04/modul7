...
class ProductController extends Controller
{
    ...
    public function store (Request $request) {
        $request->validate([
            ...
            'body' => 'required',
            'image' => 'required|image|mines::jpg,jpng,jpeg'
        ]);
    ...
    public function update(Request $request, $id) {
        ...
        return redirect()->route('admin.product.index')->with('success', 'New Product Hass Been Update');
    }
    ...
    public function destroy($id) {
        ...
        $data->delete();
        return redirect()->route('admin.product.index')->with('success', 'New Product Hass Been Delete');
    }
}